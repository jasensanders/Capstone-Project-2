...
public class ExampleInstrumentedTest {
    ...
    public void useAppContext() throws Exception {
        ...
        assertEquals("com.example.jasensanders.v1.folio", appContext.getPackageName());
        ...
        Uri providerCall = DataContract.MovieEntry.buildUriOwnedAll();
